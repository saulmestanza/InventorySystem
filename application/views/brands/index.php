		...
		<section class="content">
				...
				<div class="row">
						<div class="col-md-12 col-xs-12">
								...
								<button class="btn btn-primary" data-toggle="modal" data-target="#addBrandModal">Agregar Marca</button>
								<br /> <br />
								<?php endif; ?>
								<div class="box">
										<div class="box-header">
												<h3 class="box-title">Administrar Marcas</h3>
										</div>
										<!-- /.box-header -->
						...
						<form role="form" action="<?php echo base_url('brands/create') ?>" method="post" id="createBrandForm">
								<div class="modal-body">
										<div class="form-group">
												...
												<input type="text" class="form-control" id="brand_name" name="brand_name" placeholder="Ingrese nombre de la marca" autocomplete="off">
										</div>
										<div class="form-group">
						...
						<form role="form" action="<?php echo base_url('brands/update') ?>" method="post" id="updateBrandForm">
								<div class="modal-body">
										...
										<div class="form-group">
												...
												<input type="text" class="form-control" id="edit_brand_name" name="edit_brand_name" autocomplete="off">
										</div>
										<div class="form-group">
